...
To aide our instructions, we will explore the Gapminder data set. The Gapminder dataset is created by the Gapminder Foundation which is a non-profit organization that promotes sustainable global development [@gapminder].
...
In order to motivate use of the aforementioned verbs, we'll look to answer the following question: 
