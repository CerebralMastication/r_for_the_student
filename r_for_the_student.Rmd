...
The growth of the R language can be appreciated if we look at the increase in R questions being asked each month on the popular question and answer site, Stack Overflow: [@stack] In the \@ref(fig:stackoverflow) below we can see that R related new question activity on the site has grown steadily from the site's origin in 2008. Currently there are over 4000 new R related questions every month. 
