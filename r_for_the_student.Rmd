...
Lastly, we request the the summary of the model using the `tidy` command.  We see traditional traditional output with the regression coeficients, standard error, test statistic, and P Values.
