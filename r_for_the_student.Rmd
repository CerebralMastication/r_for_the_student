...
```{r icons, fig.cap='Environment With Gapminder Data', echo=FALSE, eval=TRUE}
...
<!-- I would very much like to use parsnip, however, I cannot find how to output the summary of the model.  I think this is important to show, especially if we are trying to convence readers to use R. -->
<!-- parsnip/tidymodels -->
